...
import img9 from "../../public/ds1.jpeg";
import img10 from "../../public/ds2.jpeg";
  ...
  const items = [
    {
      ...
      img: img9, // replace with your shield icon
    ...
    },
    {
      ...
      img: img10, // replace with your lock icon
  ...
  return (
    <section className="py-5 text-center bg-light">
      <div className="container">
        <h2 className="text-primary fw-bold">Data & Security</h2>
        <h2 className="fw-bold mb-5">Social Prachar: Safe. Secure. Simple.</h2>
